...
class SolicitudesModel:
    """Modelo para gestionar solicitudes de colaboración"""
    ...
    def get_all_solicitudes():
        ...
        try:
            ...
            ErrorHandler.error_db('get_all_solicitudes', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def get_solicitud_by_id(id_solicitud):
        ...
        try:
            ...
            ErrorHandler.error_db('get_solicitud_by_id', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def get_solicitudes_pendientes():
        ...
        try:
            ...
            ErrorHandler.error_db('get_solicitudes_pendientes', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def count_solicitudes_pendientes():
        ...
        try:
            ...
            ErrorHandler.error_db('count_solicitudes_pendientes', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def update_estado_solicitud(id_solicitud, estado, id_revisor, motivo_rechazo=None):
        ...
        try:
            ...
            ErrorHandler.error_db('update_estado_solicitud', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def create_user_from_solicitud(id_solicitud):
        ...
        try:
            ...
            ErrorHandler.error_db('create_user_from_solicitud', f'Error: {str(e)}', 'models/solicitudes_models.py')
    ...
    def delete_solicitud(id_solicitud):
        ...
        try:
            ...
            ErrorHandler.error_db('delete_solicitud', f'Error: {str(e)}', 'models/solicitudes_models.py')
