...
from controllers.usuario_anonimo_controller import (
    crear_usuario_anonimo as ctrl_crear_usuario_anonimo,
    obtener_usuario_por_uuid as ctrl_obtener_usuario_por_uuid,
    obtener_usuario_por_id as ctrl_obtener_usuario_por_id,
    listar_usuarios_anonimos as ctrl_listar_usuarios_anonimos,
    obtener_estadisticas as ctrl_obtener_estadisticas
)
...
def registrar_usuario_anonimo():
    ...
    try:
        resultado = ctrl_crear_usuario_anonimo()
        ...
        error_generico('registrar_usuario_anonimo', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en registrar_usuario_anonimo')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
...
def validar_usuario_anonimo(uuid_transaccion):
    ...
    try:
        resultado = ctrl_obtener_usuario_por_uuid(uuid_transaccion)
        ...
        error_generico('validar_usuario_anonimo', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en validar_usuario_anonimo')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
...
def obtener_usuario_anonimo(id_anonimo):
    ...
    try:
        resultado = ctrl_obtener_usuario_por_id(id_anonimo)
        ...
        error_generico('obtener_usuario_anonimo', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en obtener_usuario_anonimo')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
...
def listar_usuarios_anonimos():
    ...
    try:
        ...
        resultado = ctrl_listar_usuarios_anonimos(pagina, por_pagina)
        
        return jsonify(resultado), 200
            
    except Exception as e:
        error_generico('listar_usuarios_anonimos', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en listar_usuarios_anonimos')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
...
def obtener_estadisticas():
    ...
    try:
        ...
        resultado = ctrl_obtener_estadisticas()
        
        return jsonify(resultado), 200
            
    except Exception as e:
        error_generico('obtener_estadisticas', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en obtener_estadisticas')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
...
def obtener_sesion_anonima():
    ...
    try:
        ...
        error_generico('obtener_sesion_anonima', f'Error: {str(e)}', 'medio', 'routes/usuario_anonimo_routes.py', 'Error en obtener_sesion_anonima')
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
