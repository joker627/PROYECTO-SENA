...
CREATE TABLE reportes_error (
    ...
    id_anonimo INT NOT NULL COMMENT 'Usuario anónimo que reportó el error',
    ...
    id_responsable INT NULL COMMENT 'Administrador o colaborador que lo revisó',
    FOREIGN KEY (id_anonimo) REFERENCES usuarios_anonimos(id_anonimo),
...
-- 🔹 Alertas del sistema (automáticas y administrativas) 
CREATE TABLE alertas_sistema ( 
    ...
    origen_sistema VARCHAR(100) NULL, 
    funcion_fallida VARCHAR(150) NULL, 
    descripcion TEXT, 
    hash_error VARCHAR(64) UNIQUE NOT NULL COMMENT 'Hash MD5 de modulo+tipo_error+funcion_fallida para evitar duplicados',
    contador_ocurrencias INT DEFAULT 1 COMMENT 'Número de veces que ocurrió el mismo error',
